...
TEST_CASE("OrthogonalQueryRegion - query region contains vertex", "[OrthogonalQueryRegion]") {
    const OrthogonalQueryRegion<2> queryRegion{{{-1, -1}, {1, 1}}};
    ...
    SECTION("Query region contains vertex on the boundary of the region") {
        ...
        REQUIRE(queryRegion.Contains({-1, -1}));
    }
...
TEST_CASE("OrthogonalQueryRegion - query region covers KdTree region", "[OrthogonalQueryRegion]") {
    const OrthogonalQueryRegion<2> queryRegion{{{-1, -1}, {1, 1}}};
...
TEST_CASE("OrthogonalQueryRegion - query intersects KdTree region", "[OrthogonalQueryRegion]") {
    const OrthogonalQueryRegion<2> queryRegion{{{-1, -1}, {1, 1}}};
